...
pub fn lookup(locale: &icu_provider::DataLocale) -> Option<&'static DataStruct> {
    ...
    static DATA: [&DataStruct; 394usize] = [
        ...
        &DE_CH, &DE, &DE, &DE, &DSB, &EL, &EL, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES,
        &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ET, &EU,
        &FA, &FA, &FI, &FIL, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR,
        &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR,
        &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &GA, &GA, &GD, &GL,
        &GU, &HA, &HA, &HA, &HE, &HI, &EN, &BS, &BS, &HSB, &HU, &HY, &EN, &IG, &IS, &IT, &IT, &IT,
        &IT, &JA, &JV, &KA, &KK, &KM, &KN, &KO, &KO, &KOK, &KY, &LO, &LT, &LV, &MK, &ML, &MN, &MR,
        &EN, &EN, &EN, &EN, &MY, &NB, &NB, &HI, &HI, &NL, &NL, &NL, &NL, &NL, &NL, &NL, &NB, &NB,
        &OR, &PA, &PA, &PCM, &PL, &PS, &PS_PK, &PT, &PT, &PT, &PT, &PT, &PT, &PT, &PT, &PT, &PT,
        &PT, &PT, &QU, &QU, &QU, &RO, &RO, &RU, &RU, &RU, &RU, &RU, &RU, &SD, &SD, &SI, &SK, &SL,
        &SO, &SO, &SO, &SO, &SQ, &SQ, &SQ, &SR, &SR, &SR, &SR, &SR, &BS, &BS, &BS, &BS, &SV, &SV,
        &SV, &SW, &SW_CD, &EN, &SW, &TA, &TA, &TA, &TA, &TE, &TH, &TK, &TO, &TR, &TR, &UK, &UND,
        &UR, &UR, &UZ, &UZ, &VI, &YO, &YO_BJ, &YUE, &YUE_HANS, &YUE, &ZH, &ZH, &ZH, &ZH, &ZH,
        &ZH_HANT, &ZH_HANT, &ZH_HANT, &ZU,
    ];
