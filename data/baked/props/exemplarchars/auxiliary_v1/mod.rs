...
pub fn lookup(locale: &icu_provider::DataLocale) -> Option<&'static DataStruct> {
    ...
    static DATA: [&DataStruct; 394usize] = [
        ...
        &AR_MA, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AS, &AZ, &AZ, &BE,
        &BE, &BG, &BN, &BN, &BS, &BS, &CA, &CA, &CA, &CA, &CA, &AM, &CS, &CY, &DA, &DA, &DE, &DE,
        &DE, &DE, &DE, &DE, &DE, &DSB, &EL, &EL, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN,
        &EN, &EN, &EN, &EN_ZA, &EN, &EN, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES,
        &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ES, &ET,
        &EU, &FA, &FA_AF, &FI, &FIL, &FR, &FR, &FR, &FR, &FR, &FR, &FR_CA, &FR, &FR, &FR, &FR, &FR,
        &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR,
        &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &GA, &GA,
        &GD, &GL, &GU, &HA, &HA, &HA_NE, &HE, &HI, &HI_LATN, &BS, &BS, &HSB, &HU, &HY, &EN, &IG,
        &IS, &IT, &IT, &IT, &IT, &JA, &JV, &KA, &AM, &KM, &KN, &KO, &KO, &HI, &KY, &LO, &LT, &LV,
        &MK, &AM, &MN, &HI, &AM, &AM, &AM, &AM, &MY, &NB, &NB, &HI, &HI, &NL, &NL, &NL, &NL, &NL,
        &NL, &NL, &NN, &NB, &OR, &PA, &PA, &PCM, &PL, &PS, &PS_PK, &PT, &PT, &PT, &PT, &PT, &PT,
        &PT, &PT, &PT, &PT, &PT, &PT, &QU, &QU, &QU, &RO, &RO, &RU, &RU, &RU, &RU, &RU, &RU, &SD,
        &SD, &SI, &SK, &SL, &SO, &SO, &SO, &SO, &AZ, &AZ, &AZ, &SR, &SR, &SR, &SR, &SR, &SR_LATN,
        &SR_LATN, &SR_LATN, &SR_LATN, &SV, &SV, &SV, &SW, &SW_CD, &SW, &SW, &OR, &OR, &OR, &OR,
        &TE, &TH, &TK, &TO, &TR, &TR, &UK, &AM, &UR, &UR, &UZ, &UZ, &VI, &YO, &YO, &YUE, &YUE_HANS,
        &YUE, &ZH, &ZH, &ZH, &ZH, &ZH, &ZH_HANT, &ZH_HANT, &ZH_HANT, &EN,
    ];
...
static PS_PK: DataStruct = include!("ps-PK.rs.data");
...
static SW_CD: DataStruct = include!("sw-CD.rs.data");
