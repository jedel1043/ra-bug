...
pub fn lookup(locale: &icu_provider::DataLocale) -> Option<&'static DataStruct> {
    ...
    static DATA: [&DataStruct; 394usize] = [
        ...
        &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AS, &AF, &AF, &BE, &BE,
        &BG, &AF, &AF, &BS, &BS, &CA, &CA, &CA, &CA, &CA, &AF, &CS, &AF, &DA, &DA, &DE, &DE, &DE,
        &DE, &DE, &DE, &DE, &DSB, &EL, &EL, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF,
        &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF,
        &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF,
        &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF,
        &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF,
        &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &AF,
        &AF, &AF, &AF, &AF, &AF, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA,
        &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &CA, &ET, &AF, &FA,
        &FA, &FI, &FIL, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR,
        &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR,
        &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &AF, &AF, &GD, &CA, &AF,
        &HA, &HA, &HA, &HE, &HI, &AF, &HR, &HR, &DSB, &HU, &HY, &AF, &IG, &IS, &IT, &IT, &IT, &IT,
        &JA, &JV, &KA, &KK, &KM, &KN, &KO, &KO, &AF, &DE, &AF, &LT, &LV, &MK, &AF, &AF, &KN, &AF,
        &AF, &AF, &AF, &MY, &NB, &NB, &NE, &NE, &AF, &AF, &AF, &AF, &AF, &AF, &AF, &NB, &NB, &AF,
        &PA, &PA, &AF, &PL, &PS, &PS, &AF, &PT_AO, &PT_AO, &PT_AO, &PT_AO, &PT_AO, &PT_AO, &PT_AO,
        &PT_AO, &PT_AO, &PT_AO, &PT_AO, &AF, &AF, &AF, &RO, &RO, &DE, &DE, &DE, &DE, &DE, &DE, &SD,
        &SD, &AF, &CS, &SL, &AF, &AF, &AF, &AF, &SQ, &SQ, &SQ, &SR, &SR, &SR, &SR, &SR, &SR, &SR,
        &SR, &SR, &AF, &AF, &AF, &SW, &SW, &SW, &SW, &AF, &AF, &AF, &AF, &TE, &TH, &TK, &AF, &AF,
        &AF, &UK, &JV, &UR, &UR, &AF, &AF, &AF, &YO, &YO, &YUE, &YUE_HANS, &YUE, &YUE_HANS,
        &YUE_HANS, &YUE_HANS, &YUE_HANS, &YUE_HANS, &YUE, &YUE, &YUE, &JV,
    ];
