...
impl AnyProvider for BakedDataProvider {
    fn load_any(&self, key: DataKey, req: DataRequest) -> Result<AnyResponse, DataError> {
        ...
        const ALNUMV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::AlnumV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        #[cfg(feature = "icu_properties")]
        const BLANKV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::BlankV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        #[cfg(feature = "icu_properties")]
        const CASESENSITIVEV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::CaseSensitiveV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        #[cfg(feature = "icu_properties")]
        const GRAPHV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::GraphV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        #[cfg(feature = "icu_properties")]
        const GRAPHEMELINKV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::GraphemeLinkV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        const HEXDIGITV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::HexDigitV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        const HYPHENV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::HyphenV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        #[cfg(feature = "icu_properties")]
        const NFCINERTV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::NfcInertV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        const NFDINERTV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::NfdInertV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        const NFKCINERTV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::NfkcInertV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        const NFKDINERTV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::NfkdInertV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        #[cfg(feature = "icu_properties")]
        const PRINTV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::PrintV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        #[cfg(feature = "icu_properties")]
        const SEGMENTSTARTERV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::SegmentStarterV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        #[cfg(feature = "icu_properties")]
        const XDIGITV1MARKER: ::icu_provider::DataKeyHash =
            ::icu_properties::provider::XdigitV1Marker::KEY.hashed();
        #[cfg(feature = "icu_properties")]
        ...
        match key.hashed() {
            ...
            ORDINALV1MARKER => plurals::ordinal_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            ALNUMV1MARKER => props::alnum_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            BIDIMIRROREDV1MARKER => props::bidi_m_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            BLANKV1MARKER => props::blank_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            CASEIGNORABLEV1MARKER => props::ci_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            CASESENSITIVEV1MARKER => props::sensitive_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            CHANGESWHENCASEFOLDEDV1MARKER => props::cwcf_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            CHANGESWHENCASEMAPPEDV1MARKER => props::cwcm_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            EXTENDERV1MARKER => props::ext_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            FULLCOMPOSITIONEXCLUSIONV1MARKER => props::comp_ex_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            GENERALCATEGORYV1MARKER => props::gc_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            GRAPHV1MARKER => props::graph_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            GRAPHEMEEXTENDV1MARKER => props::gr_ext_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            GRAPHEMELINKV1MARKER => props::gr_link_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            HEXDIGITV1MARKER => props::hex_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            HYPHENV1MARKER => props::hyphen_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            MATHV1MARKER => props::math_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            NFCINERTV1MARKER => props::nfcinert_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            NFDINERTV1MARKER => props::nfdinert_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            NFKCINERTV1MARKER => props::nfkcinert_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            NFKDINERTV1MARKER => props::nfkdinert_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            PATTERNWHITESPACEV1MARKER => props::pat_ws_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            PREPENDEDCONCATENATIONMARKV1MARKER => props::pcm_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            PRINTV1MARKER => props::print_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            SCRIPTWITHEXTENSIONSPROPERTYV1MARKER => props::scx_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            SEGMENTSTARTERV1MARKER => props::segstart_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
            ...
            WORDBREAKV1MARKER => props::wb_v1::DATA
                ...
                .ok_or(DataErrorKind::MissingLocale),
            #[cfg(feature = "icu_properties")]
            XDIGITV1MARKER => props::xdigit_v1::DATA
                .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                .copied()
                .map(AnyPayload::from_static_ref)
                .ok_or(DataErrorKind::MissingLocale),
