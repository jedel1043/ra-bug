...
impl DataProvider<::icu_properties::provider::AlnumV1Marker> for BakedDataProvider {
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::BlankV1Marker> for BakedDataProvider {
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::CaseSensitiveV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::CaseSensitiveV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::sensitive_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::ChangesWhenCasemappedV1Marker> for BakedDataProvider {
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::FullCompositionExclusionV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::FullCompositionExclusionV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::comp_ex_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::GraphV1Marker> for BakedDataProvider {
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::GraphemeLinkV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::GraphemeLinkV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::gr_link_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::HyphenV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::HyphenV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::hyphen_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::NfcInertV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::NfcInertV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::nfcinert_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::NfdInertV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::NfdInertV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::nfdinert_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::NfkcInertV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::NfkcInertV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::nfkcinert_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::NfkdInertV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::NfkdInertV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::nfkdinert_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::PrependedConcatenationMarkV1Marker> for BakedDataProvider {
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::PrintV1Marker> for BakedDataProvider {
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::SegmentStarterV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::SegmentStarterV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::segstart_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
...
#[cfg(feature = "icu_properties")]
impl DataProvider<::icu_properties::provider::XdigitV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_properties::provider::XdigitV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *props::xdigit_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
